...
\begin{figure}[H]
  \includegraphics[width=\textwidth]{barplots_pre_dedup/all_condition.0.1.0.9.10.png}
\caption{SNP count with constraints: $0.1\le af \le 0.9$, $cov = 10$ }
\end{figure}
\input{tables_pre_dedup/all_condition.0.1.0.9.10}
...
\begin{figure}[H]
  \includegraphics[width=\textwidth]{barplots_pre_dedup/all_condition.0.1.0.9.20.png}
\caption{SNP count with constraints: $0.1\le af \le 0.9$, $cov = 20$ }
\end{figure}
\input{tables_pre_dedup/all_condition.0.1.0.9.20}
...
\begin{figure}[H]
  \includegraphics[width=\textwidth]{barplots_pre_dedup/all_condition.0.2.0.8.10.png}
\caption{SNP count with constraints: $0.2\le af \le 0.8$, $cov = 10$ }
\end{figure}
\input{tables_pre_dedup/all_condition.0.2.0.8.10}
...
\begin{figure}[H]
  \includegraphics[width=\textwidth]{barplots_pre_dedup/all_condition.0.2.0.8.20.png}
\caption{SNP count with constraints: $0.2\le af \le 0.8$, $cov = 20$ }
\end{figure}
\input{tables_pre_dedup/all_condition.0.2.0.8.20}
\end{document}
